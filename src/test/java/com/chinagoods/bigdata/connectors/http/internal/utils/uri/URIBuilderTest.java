...
import com.chinagoods.bigdata.connectors.http.internal.utils.URIBuilder;
...
import com.chinagoods.bigdata.connectors.http.LookupArg;
    ...
    public static Stream<Arguments> uriArgs() {
        return Stream.of(
            Arguments.of(
                ...
                "?id=1&name=2"),
            Arguments.of(Arrays.asList(new LookupArg("name", ""), (new LookupArg("id", ""))),
                "?id=&name="),
            Arguments.of(
                Arrays.asList(new LookupArg("name", " "), (new LookupArg("id", " "))),
                "?id=+&name=+"),
            Arguments.of(
                Arrays.asList(new LookupArg("name", null), (new LookupArg("id", null))),
                "?id&name"),
            Arguments.of(
                Arrays.asList(new LookupArg("name", "what+%25+is+in+HTTP+URL"), (new LookupArg("id", "1"))),
