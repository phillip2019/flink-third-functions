package com.chinagoods.bigdata.connectors.http.internal.security;
...
public class SecurityContext {
    ...
    public void addMTlsCerts(String publicKeyPath, String privateKeyPath) {
        ...
        try {
            byte[] publicData = Files.readAllBytes(new File(publicKeyPath).toPath());
            byte[] privateData = Files.readAllBytes(new File(privateKeyPath).toPath());
